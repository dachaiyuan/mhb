...
class AuthPerson extends Component {
  ...
  setImage = async imageType => {
    ...
    imageType === 'font' && (this.form.verification_images[0] = res.url);
    imageType === 'back' && (this.form.verification_images[1] = res.url);
    imageType === 'handheld' && (this.form.verification_images[2] = res.url);
  ...
  render() {
    const { font, back, handheld } = this.state;
      ...
      >
        <View class='container top-line'>
          ...
          <View class='ocrs'>
            ...
            <View onClick={this.setImage.bind(this,'handheld')}  class='ocr'>
              <View class='image' style={{backgroundImage: `url(${handheld.url || imgs.idCardHand})`}}></View>
              <View style={{color:handheld.color}}>{handheld.text}</View>
            </View>
          </View>
          <View class='form'>
            <View class='item'>
